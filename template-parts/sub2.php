            ...
            <div class="container">
                <div class="row justify-content-start align-items-end">
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\8冷凝機組.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\8冷凝機組.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\9散熱機組-1024x683.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\9散熱機組-1024x683.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\A_01散熱機組.png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\A_01散熱機組.png" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\A_02蒸發機組.png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\A_02蒸發機組.png" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\A_23貫穿式冷凝機組.png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\A_23貫穿式冷凝機組.png" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\A_24高濕度蒸發機組.png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\A_24高濕度蒸發機組.png" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\KC冷凝器-1024x790.png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\KC冷凝器-1024x790.png" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub2\貫穿式冷藏機組-超商子母櫃-1 (1).png" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub2\貫穿式冷藏機組-超商子母櫃-1 (1).png" alt="" >
                            </div>                
