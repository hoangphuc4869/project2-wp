            ...
            <div class="container">
                <div class="row justify-content-start align-items-end">
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub3\1熱回收節能型空調箱.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub3\1熱回收節能型空調箱.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub3\1臥式空調箱.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub3\1臥式空調箱.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-4 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub3\2立式空調箱.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub3\2立式空調箱.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-6 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub3\4變頻式氣冷熱回收、熱泵主機-拷貝.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub3\4變頻式氣冷熱回收、熱泵主機-拷貝.jpg" alt="" >
                            </div>                
                    ...
                    <div class="col-xl-6 col-sm-6">                                         
                        <figure>     
                            <img src="images\sub3\5變頻式室外機組.jpg" alt="" class="Image"> 
                            <div  class="modal">
                                <span class="close">&times;</span>
                                <img src="images\sub3\5變頻式室外機組.jpg" alt="" >
                            </div>                
