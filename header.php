      ...
      <div class="header_wrapper" data-aos="slide-down">
        <div class="header">
          <div class="header_img">
            <a href="<?php bloginfo('template_directory') ?>\index.php"><img src="images\圖片1 (1).jpg" alt=""></a>
          ...
          <?php wp_nav_menu (
			    array('theme_location' => 'menu-1', 'menu_class' => 'navbar_list'));?>

          <!-- <div class="navbar_list">
            <ul>
              <li><a href="<?php bloginfo('template_directory') ?>\template-parts\index.php">關於嘉祿</a></li>
              ...
              <li>
                ...
                <ul class="subnav ps-0">
                  <li><a href="<?php bloginfo('template_directory') ?>\template-parts\sub1.php">商用空調系列</a></li>
                  <li><a href="<?php bloginfo('template_directory') ?>\template-parts\sub2.php">冷凍冷藏系列</a></li>
                  <li><a href="<?php bloginfo('template_directory') ?>\template-parts\sub3.php">節能空調系列</a></li>
                  <li><a href="<?php bloginfo('template_directory') ?>\template-parts\sub4.php">產業空調系列</a></li>
                  <li><a href="<?php bloginfo('template_directory') ?>\template-parts\sub5.php">冰水主機系列</a></li>
                </ul>
              </li>
              <li><a href="<?php bloginfo('template_directory') ?>\template-parts\timeline.php">銷售實績</a></li>
              <li><a href="<?php bloginfo('template_directory') ?>\template-parts\posts.php">最新消息</a></li>
